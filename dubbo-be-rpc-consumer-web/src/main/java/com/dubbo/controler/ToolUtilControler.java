...
import com.dubbo.common.data.response.StringResponse;
...
public class ToolUtilControler {
    ...
    public void getLoginCode(HttpServletResponse resp, @RequestParam String key) throws Exception {
        ...
        //将四位数字的验证码保存到redis中。
        redisRepositoryCustom.saveMinutes(RpcConstant.LOGIN_CODE_PREFIX + key, Md5Util.MD5Encode(randomCode.toString()), RpcConstant.LOGIN_CODE_SAVE_TIME);
